export default function HeroSection2() {
  return (
    <section className="py-32 bg-[var(--cres-secondary-bg)] bg-[url('/backround.png')] bg-repeat bg-cover bg-center">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[
            ...
            <div key={i} className="group p-8 rounded-xl bg-black border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">

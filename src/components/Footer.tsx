export default function Footer() {
  const linkClass =
    'text-white/85 hover:text-[var(--orange-energy)] transition-colors duration-200 text-xs block py-0.5';
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 md:gap-10 lg:gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><a href="/events" className={linkClass}>Events</a></li>
          ...
          <div>
            ...
            <div className="space-y-2 mb-4">
              ...
              <span className="text-white/70 text-xs block">Kivuli Tower, 3rd Floor Westlands, Nairobi, Kenya</span>
            </div>
            <div className="flex items-center gap-4 mb-4">
              <a href="https://x.com/cresdynamics" target="_blank" rel="noopener noreferrer" className="text-white/85 hover:text-[var(--teal-accent)] transition-colors" aria-label="X (Twitter)">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://www.instagram.com/cresdynamics?igsh=MWN1M2xnOTlkc2huYQ==" target="_blank" rel="noopener noreferrer" className="text-white/85 hover:text-[var(--teal-accent)] transition-colors" aria-label="Instagram">

      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-3xl mx-auto">
          <div className="text-center">
            ...
            <div className="text-xs md:text-sm text-[var(--cres-text-secondary)]">Businesses Transformed</div>
          </div>
          <div className="text-center">
            <div className="text-xl md:text-3xl font-bold text-[var(--cres-orange-primary)] mb-1 md:mb-2">300%</div>
            <div className="text-xs md:text-sm text-[var(--cres-text-secondary)]">Average Growth</div>
          </div>
          <div className="text-center">
            <div className="text-xl md:text-3xl font-bold text-[var(--cres-orange-primary)] mb-1 md:mb-2">24/7</div>
            <div className="text-xs md:text-sm text-[var(--cres-text-secondary)]">System Support</div>
          </div>
        </div>
      </div>
    </section>

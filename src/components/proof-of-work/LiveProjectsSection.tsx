...
export default function LiveProjectsSection() {
  ...
  return (
    <section className="relative py-12 md:py-16 bg-white text-[var(--navy-primary)]">
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <header className="max-w-3xl mb-8 md:mb-10">
          <h2 className="text-lg md:text-2xl font-black text-[var(--navy-primary)] leading-tight mb-2">
            Live in Production
          </h2>
          <p className="text-xs md:text-sm text-[var(--navy-primary)]/75 font-medium">
            Systems we shipped. Businesses they run.
          </p>
        </header>

        <div
          className="flex flex-wrap gap-1.5 mb-8 md:mb-10"
          role="toolbar"
          ...
          {LIVE_PROJECT_FILTERS.map((f) => {
            ...
            return (
              <button
                ...
                className={`rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide border transition-all duration-300 ${
                  isOn

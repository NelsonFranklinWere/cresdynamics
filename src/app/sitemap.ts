...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/case-studies/the-stems-flowers/`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/case-studies/floral-whispers-gifts/`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/case-studies/whitelight-store/`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/case-studies/mohaa-finest/`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/case-studies/spark-lights-254/`, lastModified: now, changeFrequency: 'monthly', priority: 0.85 },

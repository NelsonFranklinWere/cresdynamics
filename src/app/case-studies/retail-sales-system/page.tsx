    ...
    <div className="min-h-screen bg-[var(--cres-primary-bg)] text-white">
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br bg-texture bg-cover from-[var(--cres-deep-navy)] via-[#0D1B2A] to-[#1B263B] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-10">
          <CaseStudyHeadline
            {...CASE_STUDY_HEADLINES['retail-sales-system']}
            centered
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-6 text-white">
            <div className="grid md:grid-cols-2 gap-8">
              <div><h3 className="font-bold text-white mb-2">Industry</h3><p>Retail store specializing in electronics</p></div>
              <div><h3 className="font-bold text-white mb-2">Business Size</h3><p>Single location with high foot traffic</p></div>
              <div><h3 className="font-bold text-white mb-2">Market Situation</h3><p>Competitive Nairobi electronics market</p></div>
              <div><h3 className="font-bold text-white mb-2">Growth Stage</h3><p>Traffic-heavy but conversion-challenged</p></div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Customer Journey Mapping</h3>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Sales Performance Dashboard</h3>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Automated Nurture System</h3>
            ...
            <div className="mt-8 p-6 bg-[var(--cres-electric-teal)]/10 rounded-lg border border-[var(--cres-electric-teal)]/20">
              <p className="text-white font-semibold">System Integration: Every customer touchpoint connects to create a seamless, optimized sales experience.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[var(--cres-secondary-bg)] border border-white/20 p-6 rounded-lg shadow-sm">
              <h3 className="text-sm font-bold text-[var(--cres-electric-teal)] mb-3">Predictable Sales Growth</h3>
            ...
            <div className="bg-[var(--cres-secondary-bg)] border border-white/20 p-6 rounded-lg shadow-sm">
              <h3 className="text-sm font-bold text-[var(--cres-electric-teal)] mb-3">Customer Experience Optimization</h3>
              <p className="text-white">Streamlined purchase process that reduces friction and increases customer satisfaction.</p>
            </div>
            <div className="bg-[var(--cres-secondary-bg)] border border-white/20 p-6 rounded-lg shadow-sm">
              <h3 className="text-sm font-bold text-[var(--cres-electric-teal)] mb-3">Data-Driven Decisions</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Traffic doesn't equal sales</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Customer journeys are complex</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Data enables optimization</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Systems create consistency</h3>

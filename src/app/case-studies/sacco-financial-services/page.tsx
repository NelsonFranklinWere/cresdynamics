...
export default function SaccoCaseStudyPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--cres-deep-navy)] via-[#0D1B2A] to-[#1B263B] bg-texture bg-cover relative overflow-hidden">

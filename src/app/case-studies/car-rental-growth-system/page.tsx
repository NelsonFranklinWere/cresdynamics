        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Real-Time Inventory Website</h3>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">SEO & Local Visibility System</h3>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Brand Authority Platform</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Operational success doesn't guarantee digital readiness</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Customer journeys are multichannel</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Systems enable scaling, tools just add complexity</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-white mb-1">Local market understanding drives success</h3>

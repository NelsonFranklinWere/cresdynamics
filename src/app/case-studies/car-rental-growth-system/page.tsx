          ...
          <div className="space-y-6">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm">Created a "beautiful website" but didn't understand car rental business needs or customer behavior.</p>
              </div>

              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <div className="text-4xl mb-4">🔧</div>
                <h3 className="font-bold text-[var(--cres-deep-navy)] mb-3">Generic Booking Tools</h3>
                <p className="text-gray-600 text-sm">Off-the-shelf booking systems that didn't integrate with their existing operations or local payment methods.</p>
              </div>

              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <div className="text-4xl mb-4">📊</div>
                <h3 className="font-bold text-[var(--cres-deep-navy)] mb-3">No Integration Planning</h3>
                <p className="text-gray-600 text-sm">Individual tools purchased separately without considering how they work together as a system.</p>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">A mobile-optimized website showing live availability across all locations, with instant booking capability.</p>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">Comprehensive local SEO strategy to dominate car rental searches in Nairobi.</p>
                <ul className="text-gray-600 text-sm space-y-1">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">Content and systems to establish them as Nairobi's most trusted car rental experts.</p>
                <ul className="text-gray-600 text-sm space-y-1">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">Reduced phone inquiries by 60% through self-service booking, allowing staff to focus on customer service rather than basic information requests.</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-bold text-[var(--cres-electric-teal)] mb-3">Revenue Growth Foundation</h3>
              <p className="text-gray-700">Established systems that support scaling from 2 to 4 showrooms, with clear processes for inventory management and customer experience.</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-bold text-[var(--cres-electric-teal)] mb-3">Market Position</h3>
              <p className="text-gray-700">Became the most visible car rental company online in Nairobi, with customers choosing them based on digital research rather than just location.</p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-bold text-[var(--cres-electric-teal)] mb-3">Scalable Operations</h3>
              <p className="text-gray-700">Created standardized processes that work whether managing 50 vehicles or 200, with systems that grow with the business.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Just because your physical business works doesn't mean your digital systems support growth.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Modern customers research online, compare offline, and expect seamless experiences across all touchpoints.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Individual tools create more work. Integrated systems reduce complexity while enabling growth.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Kenyan customer behavior, payment preferences, and mobile usage patterns require tailored solutions.</p>
              </div>
            </div>
          </div>
        </div>

...
export const metadata: Metadata = {
  ...
  description:
    'Eastleigh’s finest curtains, finally found online — website + SEO build for Mohaa Finest. Live and indexed at mohaafinestcurtains.co.ke.',
  alternates: { canonical: 'https://cresdynamics.com/case-studies/mohaa-finest/' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Case Study — Mohaa Finest | Cres Dynamics',
    description:
      'Mohaa Finest website + SEO build for Nairobi curtain and home decor demand. Live at mohaafinestcurtains.co.ke.',

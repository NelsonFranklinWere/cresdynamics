        ...
        <div className="relative z-10">
          <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center">
              <a href="/contact" className="bg-[var(--cres-electric-teal)] hover:bg-[#00B894] text-white font-black text-sm md:text-lg py-3 md:py-4 px-6 md:px-8 rounded-lg transition-all duration-300 hover:shadow-2xl hover:scale-105">
                Discuss your growth constraints
              </a>
              <a href="/insights" className="border-2 border-gray-400 text-gray-300 hover:text-white hover:border-white font-semibold text-sm md:text-lg py-3 md:py-4 px-6 md:px-8 rounded-lg transition-all duration-300">
                Read more insights
              </a>
            </div>
          </div>
